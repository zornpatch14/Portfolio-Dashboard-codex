...
export function normalizeSelection(selection: Selection): Selection {
  return {
    ...
    contracts: sortMap(selection.contracts) || {},
    margins: sortMap(selection.margins) || {},
    contractMultipliers: sortMap(selection.contractMultipliers),
    marginOverrides: sortMap(selection.marginOverrides),
  };
}
